...
class __TwigTemplate_5abdfcab6467cee9d14335ff979569ea extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["roles_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["roles_link_text"] ?? null), 8, $this->source), "entity.user_role.collection"));
        // line 9
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/user.new_role.html.twig", "/var/www/html/web/core/modules/help_topics/help_topics/user.new_role.html.twig");
    }
