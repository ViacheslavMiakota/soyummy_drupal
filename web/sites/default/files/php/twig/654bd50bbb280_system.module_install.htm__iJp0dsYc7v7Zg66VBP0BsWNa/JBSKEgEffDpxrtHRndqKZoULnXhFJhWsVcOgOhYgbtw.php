...
class __TwigTemplate_e978ccb2b572ace7b97a3de39443fac1 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["extend_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["extend_link_text"] ?? null), 8, $this->source), "system.modules_list"));
        // line 9
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/system.module_install.html.twig", "/var/www/html/web/core/modules/help_topics/help_topics/system.module_install.html.twig");
    }
