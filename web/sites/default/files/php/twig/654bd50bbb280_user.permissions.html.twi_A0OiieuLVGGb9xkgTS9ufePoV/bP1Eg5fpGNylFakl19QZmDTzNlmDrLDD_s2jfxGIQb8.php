...
class __TwigTemplate_e8eda46672d01d94f16fb589b2ca5f11 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 9
        $context["permissions_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["permissions_link_text"] ?? null), 9, $this->source), "user.admin_permissions"));
        // line 10
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/user.permissions.html.twig", "/var/www/html/web/core/modules/help_topics/help_topics/user.permissions.html.twig");
    }
