...
class __TwigTemplate_db86c373e1061bfc3feae84ec1ff38ff extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 8
        $context["account_settings_link"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["account_settings_link_text"] ?? null), 8, $this->source), "entity.user.admin_form"));
        // line 9
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/user.security_account_settings.html.twig", "/var/www/html/web/core/modules/help_topics/help_topics/user.security_account_settings.html.twig");
    }
