...
class __TwigTemplate_c3d7417669597d5cb19c27799ee44bc5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 11
        $context["views"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["views_link_text"] ?? null), 11, $this->source), "entity.view.collection"));
        // line 12
        ob_start(function () { return ''; });
        // line 13
        echo "  ";
        ...
        // line 15
        $context["views_permissions"] = $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\help_topics\HelpTwigExtension']->getRouteLink($this->sandbox->ensureToStringAllowed(($context["views_permissions_link_text"] ?? null), 15, $this->source), "user.admin_permissions.module", ["modules" => "views_ui"]));
        // line 16
        echo "<h2>";
        echo t("Goal", array());
        echo "</h2>
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/views_ui.bulk_operations.html.twig", "/var/www/html/web/core/modules/help_topics/help_topics/views_ui.bulk_operations.html.twig");
    }
